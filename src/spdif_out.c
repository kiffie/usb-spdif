...
#define _REFOCON_ROSEL_POSITION _REFO1CON_ROSEL_POSITION
#define _REFOCON_ON_MASK _REFO1CON_ON_MASK
#define _REFOCON_OE_MASK _REFO1CON_OE_MASK
#define _REFOCON_DIVSWEN_MASK _REFO1CON_DIVSWEN_MASK
#define _REFOTRIM_ROTRIM_POSITION _REFO1TRIM_ROTRIM_POSITION
#define _REFOCON_RODIV_POSITION _REFO1CON_RODIV_POSITION
#endif
