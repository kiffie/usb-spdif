...
originally from http://www.sparetimelabs.com/tinyprintf/index.html
Licenses: LGPL 2.1 or later (see LICENSE.LGPL-2.1)
      or  BSD-new           (see LICENSE.BSD-new)

see also https://github.com/cjlano/tinyprintf
...
int tfp_printf(const char *fmt, ...)
{
    ...
    va_end(va);
    return 0; /* incorrect, should return the number of printed characters */
}
#endif
